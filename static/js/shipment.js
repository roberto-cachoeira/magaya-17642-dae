...
function subMitValueMagaya() {
    ...
    let shipperName = document.getElementById('divShipper').innerHTML;
    let destinationCountry = document.getElementById('divDestination').innerHTML;
    let expDate = document.getElementById('expDate').value;
    if (dae != "" && shipperName != "" && destinationCountry != "" && expDate != "") {
        fetch(`./saveConfig`, {
            method: 'POST',
            body: JSON.stringify({
                dae: dae,
